...
with st.expander("🐾有關本系統", expanded=False):
    ...
    <span style='color: #64748b; font-size: 15px;'>BY 你們的好朋友~教學研究部</span>
    <br>
    </p>
    """, unsafe_allow_html=True)

with st.expander("🚀 出國資源法規導航員", expanded=False):
    st.markdown("<p style='font-size: 14.5px; margin: 0;'><a href='https://gemini.google.com/gem/18x5GMgjMdXG5Ume9-ySxoECpU7qS4mzA?usp=sharing' style='color: #d8b4fe; font-weight: bold; text-decoration: underline;'>戳我一下，看看有哪些經費補助和公假可以申請&相關規範與流程來查詢~</a>
    <br>
